...
function buttn6(e){
  ...
  totalnum.text(`${inputed5 + inputed4 + inputed3+inputed2+inputed1} lbs CO2 released per year. That is the equivalent of driving a car ${(inputed5 + inputed4 + inputed3+inputed2+inputed1)*0.9} miles`);
}

var yesbuttn= $('.yesbuttn')

var placeholdcloths= $('#cloths1')
yesbuttn.on('click',yesbuttn1)

function yesbuttn1(e){
  e.preventDefault();
  placeholdcloths.text(`On average that would be 242.6lbs of CO2 and the equivalent of 216 miles driven`)
}

var nobuttn= $('.nobuttn')

nobuttn.on('click',nobuttn1)

function nobuttn1(e){
  e.preventDefault();
  placeholdcloths.text(`sweet, dude`)
}
